...
const products = ref([
  { id: 1, name: 'Koko Pria Premium', price: 'Rp250.000', discount: 'New In', image: assetUrl('koko-putih.png') },
  { id: 2, name: 'Gamis Wanita Elegant', price: 'Rp280.000', discount: 'New In', image: assetUrl('gamis-pink.png') },
  { id: 3, name: 'Koko Pria Modern', price: 'Rp290.000', discount: 'New In', image: assetUrl('koko-abu.png') },
  { id: 4, name: 'Gamis Wanita Classic', price: 'Rp200.000', discount: 'New In', image: assetUrl('gamis-coklat.png') },
  { id: 5, name: 'Koko Pria Casual', price: 'Rp220.000', image: assetUrl('koko-hijau.png') },
  { id: 6, name: 'Abaya Wanita Syari', price: 'Rp300.000', image: assetUrl('abaya-hitam.png') },
  { id: 7, name: 'Gamis Executive', price: 'Rp350.000', image: assetUrl('gamis-p.png') },
  { id: 8, name: 'Hijab Trendy', price: 'Rp240.000', image: assetUrl('hijab.png') },
]);
